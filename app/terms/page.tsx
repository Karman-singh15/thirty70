    ...
    <div className="min-h-dvh bg-canvas px-6 py-16 text-ink">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-10 space-y-8 font-sans text-sm leading-relaxed text-muted">
          ...
          <section>
            <h2 className="font-mono text-base font-medium text-ink">Problem content</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-mono text-base font-medium text-ink">Subscriptions</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-mono text-base font-medium text-ink">Fair use</h2>
            <p className="mt-2">
